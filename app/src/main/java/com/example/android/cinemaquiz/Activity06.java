...
public class Activity06 extends Activity{
    ...
    public void submitButton(View view) {
        checkBox1 = (CheckBox) findViewById(R.id.q06_ch01);
        hasCheckedBox1 = checkBox1.isChecked();
        checkBox2 = (CheckBox) findViewById(R.id.q06_ch02);
        hasCheckedBox2 = checkBox2.isChecked();
        checkBox3 = (CheckBox) findViewById(R.id.q06_ch03);
        hasCheckedBox3 = checkBox3.isChecked();
        checkBox4 = (CheckBox) findViewById(R.id.q06_ch04);
        hasCheckedBox4 = checkBox4.isChecked();
        String answerQuestion1 = "Q6: ";
        ...
        if (hasCheckedBox1 == false && hasCheckedBox2 == false && hasCheckedBox3 == false && hasCheckedBox4 == false) {
            ...
            if (hasCheckedBox1 && hasCheckedBox2 && hasCheckedBox4) {
                g.increaseScore();
                Toast.makeText(this, "Excellent!", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "The Correct answer was Blue, Red and White ", Toast.LENGTH_SHORT).show();
            }
            g.setFalseq06();
            final Context context = this;
            Intent intent = new Intent(context, Activity07.class);
